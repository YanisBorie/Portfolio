function popup(popup) {
    ...
    switch (popup) {
        ...
        case "ShoppingList":
            ...
            break;
        case "Seven":
            document.getElementById('popupSeven').style.display = 'block';
            break;
        case "Valoroulette":
            document.getElementById('popupValoroulette').style.display = 'block';
            break;
    }
}
...
function popdown() {
    ...
    document.getElementById('popupSeven').style.display = 'none';
    document.getElementById('popupValoroulette').style.display = 'none';
